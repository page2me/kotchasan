...
/**
 * Generated by PHPUnit_SkeletonGenerator on 2017-04-15 at 08:50:27.
 */
class QueryBuilderTest extends \PHPUnit_Framework_TestCase
{
  ...
  public function testSelect5()
  {
    ...
    $this->assertEquals(
      "SELECT * WHERE `domain` = 'kotchasan.com'", $this->object->select()->where(array('domain', Sql::strValue('kotchasan.com')))->text()
    );
  }
  ...
  public function testSelect13()
  {
    ...
    $this->assertEquals(
      "SELECT YEAR(`create_date`) AS `year`,MONTH(`create_date`) AS `month`", $this->object->select(Sql::YEAR('create_date', 'year'), Sql::MONTH('create_date', 'month'))->text()
    );
  }
  ...
  public function testSelect14()
  {
    ...
    $this->assertEquals(
      "SELECT YEAR(`create_date`) AS `year`,MONTH(`create_date`) AS `month`", $this->object->select(array(Sql::YEAR('create_date', 'year'), Sql::MONTH('create_date', 'month')))->text()
    );
  }
  ...
  public function testWhere4()
  {
    ...
    $this->assertEquals(
      " WHERE 1 = 1", $this->object->where(array(1, 1))->text()
    );
  }
  ...
  public function testWhere5()
  {
    ...
    $this->assertEquals(
      " WHERE U.`id` = G.`id`", $this->object->where(array('U.id', 'G.id'))->text()
    );
  }
  ...
  public function testWhere8()
  {
    ...
    $this->assertEquals(
      " WHERE `id`=1 OR (SELECT ....)", $this->object->where(Sql::create('`id`=1 OR (SELECT ....)'))->text()
    );
  }
  ...
  /**
   * Generated from @assert where(array(array('fb', '0'), Sql::create('(...)')))->text() [==] " WHERE `fb` = '0' AND (...)".
   *
   * @covers Kotchasan\Database\QueryBuilder::where
   */
  public function testWhere11()
  {
    ...
    $this->assertEquals(
      " WHERE `fb` = '0' AND (...)", $this->object->where(array(array('fb', '0'), Sql::create('(...)')))->text()
    );
  }
  ...
  public function testWhere12()
  {
    ...
    $this->assertEquals(
      " WHERE MONTH(`create_date`) = 1 AND YEAR(`create_date`) = 1", $this->object->where(array(array(Sql::MONTH('create_date'), 1), array(Sql::YEAR('create_date'), 1)))->text()
    );
  }
  ...
  public function testWhere14()
  {
    ...
    $this->assertEquals(
      " WHERE `id` IN (1, 'a') AND `id` IN ('', 'th')", $this->object->where(array(array('id', array(1, 'a')), array('id', array('', 'th'))))->text()
    );
  }
  ...
  public function testWhere17()
  {
    ...
    $this->assertEquals(
      " WHERE YEAR(`create_date`) = YEAR(S.`create_date`)", $this->object->where(array(array(Sql::YEAR('create_date'), Sql::YEAR('S.`create_date`'))))->text()
    );
  }

  /**
   * Generated from @assert where(array('U.id', Sql::strValue('G.id')))->text('U.`id`') [==] " WHERE U.`id` = 'G.id'".
   *
   * @covers Kotchasan\Database\QueryBuilder::where
   */
  public function testWhere18()
  {
    ...
    $this->assertEquals(
      " WHERE U.`id` = 'G.id'", $this->object->where(array('U.id', Sql::strValue('G.id')))->text('U.`id`')
    );
  }
