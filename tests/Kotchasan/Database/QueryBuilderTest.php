...
/**
 * Generated by PHPUnit_SkeletonGenerator on 2016-11-12 at 16:15:01.
 */
class QueryBuilderTest extends \PHPUnit_Framework_TestCase
{
  ...
  public function testDelete()
  {
    ...
    $this->assertEquals(
      "DELETE FROM `user` WHERE `id` = 1 AND `name` = :name1", $this->object->delete('user', array(array('id', 1), array('name', 'test')))->text()
    );
  }
  ...
  /**
   * Generated from @assert select()->where(array('domain', 'kotchasan.com'))->text() [==] "SELECT * WHERE `domain` = :domain".
   *
   * @covers Kotchasan\Database\QueryBuilder::select
   */
  public function testSelect6()
  {
    ...
    $this->assertEquals(
      "SELECT * WHERE `domain` = :domain", $this->object->select()->where(array('domain', 'kotchasan.com'))->text()
    );
  }
  ...
  /**
   * Generated from @assert where(array(array('id', array(1, 'a')), array('id', array('G.id', 'G.`id2`'))))->text() [==] " WHERE `id` IN (:id0, :id1) AND `id` IN (G.`id`, G.`id2`)".
   *
   * @covers Kotchasan\Database\QueryBuilder::where
   */
  public function testWhere12()
  {
    ...
    $this->assertEquals(
      " WHERE `id` IN (:id0, :id1) AND `id` IN (G.`id`, G.`id2`)", $this->object->where(array(array('id', array(1, 'a')), array('id', array('G.id', 'G.`id2`'))))->text()
    );
  }
  ...
  public function testWhere13()
  {
    ...
    $this->assertEquals(
      " WHERE `ip` NOT IN ('', :ip1)", $this->object->where(array('ip', 'NOT IN', array('', '192.168.1.104')))->text()
    );
  }
